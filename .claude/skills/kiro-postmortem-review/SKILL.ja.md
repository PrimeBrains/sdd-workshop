...
**ミッション**: 蓄積された不具合 ledger から、横展開可能な学習 (Try) を抽出し steering 化する。
...
- `.kiro/postmortem/defects.md` を Read (ledger 全体)
- `.claude/skills/kiro-postmortem-add/rules/taxonomy-reference.md` を Read (有効ラベル定義)
