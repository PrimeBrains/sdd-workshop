...
| └ 設計 / └ タスク | agreed | 5人日 / 2人日 | pending | —（本ユニット対象外） | — |
| └ レビュー作業（要件定義 / 設計 / タスク） | agreed | 1 / 1 / 0.5人日（例示） | pending（依存未充足・対象外） | —（未着手） | — |
...
<table style="border-collapse:collapse;font-family:system-ui,sans-serif;font-size:13px;width:100%">
  ...
  <tr>
    <td style="padding:6px 10px 6px 28px;border:1px solid #cbd5e1">└ レビュー作業（要件定義 / 設計 / タスク）</td>
    <td style="padding:6px 10px;border:1px solid #cbd5e1" colspan="4"><span style="color:#94a3b8">（計画済み・agreed・pending・対象外。1 / 1 / 0.5人日）</span></td>
    <td style="padding:6px 10px;border:1px solid #cbd5e1">EV寄与 0</td>
  </tr>
</table>
...
<table style="border-collapse:collapse;font-family:system-ui,sans-serif;font-size:13px;width:100%;margin-top:10px">
  ...
  <tr>
    ...
    <td style="padding:6px 10px;border:1px solid #cbd5e1" colspan="4"><span style="color:#94a3b8">（要件定義が implemented になり依存充足 → <b>ready</b>（着手可・未着手）。設計/タスクのレビューは依存元 pending ゆえ pending）</span></td>
    <td style="padding:6px 10px;border:1px solid #cbd5e1">EV寄与 0</td>
  </tr>
</table>
