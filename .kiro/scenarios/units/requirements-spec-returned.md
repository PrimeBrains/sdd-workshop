...
| └ 設計 / └ タスク | agreed | 5人日 / 2人日 | pending | —（対象外） | — | 0 |
| └ レビュー作業（設計）/（タスク） | agreed | 1人日 / 0.5人日（例示） | pending（依存未充足・対象外） | —（未着手） | — | 0 |
...
<table style="border-collapse:collapse;font-family:system-ui,sans-serif;font-size:13px;width:100%">
  ...
  <tr>
    ...
    <td style="padding:6px 10px;border:1px solid #cbd5e1" colspan="4"><span style="color:#94a3b8">（計画済み・agreed・pending・対象外。設計レビュー1人日・タスクレビュー0.5人日）</span></td>
    <td style="padding:6px 10px;border:1px solid #cbd5e1">EV寄与 0</td>
  </tr>
</table>
